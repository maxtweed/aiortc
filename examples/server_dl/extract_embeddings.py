...
#Torch-based for extracting facial embeddings via deep 
...
for (i, imagePath) in enumerate(imagePaths):
	...
	# construct a blob from the image - DNN is deep neural networks
